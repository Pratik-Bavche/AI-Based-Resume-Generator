  ...
  return (
    <div className="mt-20 mb-20">
      ...
      <style>{`
        ...
        `}</style>
        <h1 className="text-3xl font-semibold text-center mx-auto">See What Our Users Say</h1>
        <p className="text-sm text-slate-500 text-center mt-2 max-w-md mx-auto">
            Real feedback from users who created professional resumes with our AI Resume Builder.
        </p>
