       ...
       <div className="min-h-screen pb-20">
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                        Build a stunning <span className=" bg-gradient-to-r from-indigo-700 to-indigo-600 bg-clip-text text-transparent text-nowrap">AI-powered</span> resume in minutes.
                    </h1>

                    <p className="max-w-md text-center text-base my-7">
                        Design, customize, and publish your personal resume with smart AI tools that make creativity effortless.
                    </p>
                    ...
                    <div className="flex items-center gap-4 ">
                        ...
                        <button className="flex items-center gap-2 border border-slate-400 hover:bg-indigo-50 transition cursor-pointer rounded-full px-7 h-12 text-slate-700">
                    ...
                    <p className="py-6 text-slate-600 mt-14">Trusted by creative teams and global startups</p>
